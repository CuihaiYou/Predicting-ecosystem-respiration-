...
Soil_scalar_fast=ones(365*9,1);
Soil_scalar_slow=ones(365*9,1);
Soil_scalar_passive=ones(365*9,1);
for ii_yr = 2009:2017
    ...
    Soil_scalar_for_fast   = soil_scalar_TECO_fast(Tsoil_yr,SWC);% soil
    Soil_scalar_for_slow   = soil_scalar_TECO_slow(Tsoil_yr,SWC);% soil
    Soil_scalar_for_passive = soil_scalar_TECO_passive(Tsoil_yr,SWC);% soil
    above_scalar(ii_d:ii_d2)=above_scalar_for;
    ab_scalar(ii_d:ii_d2)=ab_scalar_for;
    Soil_scalar_fast(ii_d:ii_d2)=Soil_scalar_for_fast;  
    Soil_scalar_slow(ii_d:ii_d2)=Soil_scalar_for_slow;   
    Soil_scalar_passive(ii_d:ii_d2)=Soil_scalar_for_passive; 
end 
 scalar_all = [above_scalar';ab_scalar';ab_scalar';Soil_scalar_fast';Soil_scalar_slow';Soil_scalar_passive'];   
